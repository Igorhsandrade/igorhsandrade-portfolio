...
import { FaExternalLinkAlt as ExternalLink, FaCalendarAlt as Calendar, FaAward as Award, FaCheckCircle as CheckCircle } from "react-icons/fa"
...
export function CertificatesSection({ certificates, showAll = false, className = "" }: CertificatesSectionProps) {
          ...
          <Card key={index} className="overflow-hidden hover:shadow-lg transition-all duration-300 group">
            <div className="relative h-48 overflow-hidden bg-gradient-to-br from-teal-50 to-blue-50 dark:from-teal-950/20 dark:to-blue-950/20">
              ...
              <div className="absolute top-4 right-4">
                <Badge className={`text-xs ${getStatusColor(certificate.status)} flex items-center gap-1`}>
            ...
            <CardContent className="p-6">
              <div className="mb-3">
                <h3 className="text-lg font-semibold mb-1 line-clamp-2">{certificate.title}</h3>
